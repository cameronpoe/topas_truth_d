...
PET_XCAT_hoffman_brain.topas is the main TOPAS file that scores gamma rays emitted from radioactive sources within the geometry inside the PET detector. It contains a statement that includes xcat_hoffman_brain.topas
